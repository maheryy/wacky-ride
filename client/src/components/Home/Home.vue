...
<template>
  <div class="main-container">
    <h1
      class="text-center mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl text-white"
    >
      Hello world !
    </h1>
    <div class="playground">
      <h2 class="text-2xl text-center font-extrabold text-white mb-4">
